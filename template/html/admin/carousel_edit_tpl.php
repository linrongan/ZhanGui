...
<section id="top">
    <div class="mainpanel">
        <div class="pageheader">
            <h2> 图片管理 <span>轮播图</span>  <span>编辑</span></h2>
                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=carousel&_index=_edit&id=<?php echo $_GET['id']; ?>&_action=ActionSetCarousel" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input name="fields_link" id="fields_link"  required value="<?php echo $data['fields_link']; ?>" type="text" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
