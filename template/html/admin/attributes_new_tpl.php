                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=attributes&_index=_new&_action=ActionNewAttrType" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">属性分类名</label>
                                                <div class="col-sm-3">
                                                    <input name="attr_type_name" required maxlength="30" value="" type="text" class="form-control"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="attr_sort" digits="true" required value="" type="number" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- panel-body -->
