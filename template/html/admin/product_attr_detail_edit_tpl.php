...
$data = $obj->GetProductAttrDetailInfo();
?>
<!DOCTYPE html>
<html lang="en">
<head>
                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=product&_index=_attr_detail_edit&id=<?php echo $_GET['id'] ?>&_action=ActionEditAttrDetail" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="attr_name" id="attr_name" maxlength="8" value="<?php echo $data['attr_name']; ?>" required type="text" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- panel-body -->
