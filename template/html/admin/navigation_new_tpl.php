...
<section id="top">
    <div class="mainpanel">
        <div class="pageheader">
            <h2> 图片管理 <span>首页导航</span>  <span>新增</span></h2>
                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=navigation&_index=_new&_action=ActionNewNavigation" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input name="fields_link" id="fields_link" required value="" type="url" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">排序</label>
                                                <div class="col-sm-3">
                                                    <input name="fields_order" id="fields_order" required digits="true" value="" type="number" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
