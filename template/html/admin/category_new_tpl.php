                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    ...
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=category&_index=_new&_action=ActionNewCategory" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="category_name" required maxlength="30" id="category_name" type="text" class="form-control"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <textarea name="category_desc"  maxlength="255"  style="width:500px;height: 700px;"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="ry_order" id="ry_order" required digits="true" value="0" type="number" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- panel-body -->
