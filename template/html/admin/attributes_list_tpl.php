                                    ...
                                    if($data['data'])
                                    {
                                        foreach($data['data'] as $item)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo $item['attr_sort']; ?></td>
                                                <td class="center">
                                                    <a title="编辑" href="javascript:;" onclick="attributes_edit(<?php echo $item['attr_type_id']; ?>)">
                                                        <span class="fa fa-edit"></span>
                                                    </a>
                                                    <a onclick="return confirm('确定要删除吗？')" title="删除"
                                                       href="/?mod=admin&v_mod=attributes&_index=_list&id=<?php echo $item['attr_type_id']; ?>&_action=ActionDelAttrType"><span class="fa fa-trash-o"></span>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
...
<script>
    function attributes_edit(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['80%', '90%'],
            content: '?mod=admin&v_mod=attributes&_index=_edit&id='+id //iframe的url
        });
    }
    ...
    function attributes_new() {
        layer.open({
            ...
            shade: 0.8,
            area: ['80%', '90%'],
            content: '/?mod=admin&v_mod=attributes&_index=_new' //iframe的url
        });
    }
</script>
</body>
