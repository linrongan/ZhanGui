    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="readonlyinput" class="col-sm-3 control-label">运营商编号</label>
                <div class="col-sm-6">
                    <input disabled type="text" readonly="readonly" class="form-control" value="<?php echo $data['usercode']; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input name="company_name" id="company_name" value="<?php echo $data['company_name']; ?>" type="text" class="form-control" placeholder="请输入公司名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" value="<?php echo $data['admin_name']; ?>" name="admin_name" id="admin_name" class="form-control"  placeholder="请输入操作员姓名">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="readonlyinput" class="col-sm-3 control-label">最后登录时间</label>
                <div class="col-sm-6" style="color: red">
                   <?php echo $data['admin_last_login']; ?>
                </div>
            </div>

            <div class="form-group">
                <label for="readonlyinput" class="col-sm-3 control-label">登录次数</label>
                <div class="col-sm-6" style="color: red">
                    <?php echo $data['admin_login_count']; ?> 次
                </div>
            </div>
        </div><!-- panel-body -->
