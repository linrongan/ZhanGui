            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" method="post" action="">
                        ...
                        <a href="?mod=admin&v_mod=product&_index=_list_down" class="btn btn-default">取消</a>
                    </form>
                </div><!-- panel-body -->
            </div>
            <div class="panel panel-default">
                <div class="panel-body">
                    <h5 class="subtitle mb5">待上架商品列表</h5>
                    <br />
    ...
    function show_price(id,title) {
        if(id && !isNaN(id))
        {
            layer.open({
                ...
                shade: 0.8,
                area: ['80%', '90%'],
                content: '/?mod=admin&v_mod=product&_index=_price&id='+id //iframe的url
            });
        }
    }
</script>
