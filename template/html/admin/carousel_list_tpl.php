...
<section>
    <div class="mainpanel">
        <div class="pageheader">
            <h2> 图片管理 <span>轮播图</span>  <span>列表</span></h2>
        ...
        <div class="contentpanel">
            <div class="panel panel-default">
                <div class="panel-body">
                    <a href="?mod=admin&v_mod=carousel&_index=_new" class="btn btn-primary">新增</a>
                </div>
                <div class="panel-body">
                            ...
                            if($data['data'])
                            {
                                foreach($data['data'] as $item)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a title="编辑" href="/?mod=admin&v_mod=carousel&_index=_edit&id=<?php echo $item['id']; ?>" >
                                                <span class="fa fa-edit"></span>
                                            </a>
                                            <a onclick="return confirm('确定要删除吗？')" title="删除"
                                               href="/?mod=admin&v_mod=carousel&_index=_list&id=<?php echo $item['id']; ?>&_action=ActionDelCarousel"><span class="fa fa-trash-o"></span>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php
