                            ...
                            <div class="tab-pane active">
                                <div class="panel panel-default">
                                    <form id="checkform" method="post"
                                          action="/?mod=admin&v_mod=attributes&_index=_attr_new&_action=ActionNewAttrValue" class="form-horizontal form-bordered">
                                        <div class="panel-body panel-body-nopadding">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="attr_name" required maxlength="30" value="" type="text" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- panel-body -->
