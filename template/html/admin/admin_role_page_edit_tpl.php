...
<section>
    <div class="mainpanel">
        <div class="contentpanel">
            <form enctype="multipart/form-data" id="checkform"  method="post" class="form-horizontal form-bordered" action="?mod=admin&_index=_role_page_edit&_action=EditRoleAuth&id=<?php echo $_REQUEST['id'];?>">
                            ...
                            <div class="panel-body panel-body-nopadding">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control mb15" id="ry_parent_id" name="ry_parent_id" required="">
                                            ...
                                            if (!empty($page_array))
                                            {
                                                ...
                                                foreach ($page_array as $page)
                                                {
                                                    $i++;
                                                    ?>
                                                    <option <?php if ($data['ry_parent_id']==$page['id']) { echo 'selected';}?>  value="<?php echo $page['id']; ?>"><?php echo $page['ry_menu']; ?></option>
                                                    <?php
                                                    if (!empty($page))
                                                    {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="ry_menu" id="ry_menu" maxlength="20" class="form-control" placeholder="请输入分类名称" value="<?php echo $data['ry_menu']; ?>" required><span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="ry_link" id="ry_link" maxlength="255" class="form-control" placeholder="" value="<?php echo $data['ry_link']; ?>">
                                        <span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="ry_order" id="ry_order" maxlength="20" class="form-control" placeholder="" value="<?php echo $data['ry_order']; ?>" required>
                                        <span></span>
                                    </div>
                                </div>
