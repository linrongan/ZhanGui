<?php
class NavigationAction extends navigation
{
    ...
    //新增
    public function ActionNewNavigation()
    {
        ...
        $res = $this->GetDBMaster()->insertquery("INSERT INTO ".TABLE_FIELDS." SET  fields_type=1,"
    ...
    //编辑
    public function ActionSetNavigation()
    {
        if(!regExp::checkNULL($this->data['submit']))
        {
            return false;
        ...
        $res = $this->GetDBMaster()->insertquery("UPDATE ".TABLE_FIELDS." SET "
            ."fields_title='".$this->data['fields_title']."',fields_image='".$this->data['fields_image']."',"
            ."fields_link='".$this->data['fields_link']."',fields_order='".$this->data['fields_order']."',"
            ."fields_show='".$this->data['fields_show']."',fields_addtime='".date("Y-m-d H:i:s",time())."' "
    ...
    public function ActionDelNavigation()
    {
        if(!regExp::checkNULL($this->data['id']))
        {
            return array('code'=>1,'msg'=>'参数错误');
